...
<head>
    ...
    <title>Najboljši apartmaji</title>
    <!-- Favicon-->
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="index.php">Apartmaji</a>
            <button
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"
                            href="apartmaji.php">Vsi apartmaji</a></li>

                    <?php
                        if(isset($_SESSION['user_id'])){
                            $first_name = $_SESSION['first_name'];
                            echo '<li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"
                            href="profil.php">Profil ('.$first_name.')</a></li>';
                            echo '<li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"
                            href="uporabniki.php">Uporabniki ('.$first_name.')</a></li>';
                            echo '<li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"
